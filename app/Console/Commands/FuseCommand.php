...
class FuseCommand extends Command
{
    ...
    {
        Log::emergency('Add support for generating into Fuse folders');
    ...
    private function make_table()
    {
        ...
        info('Table `'.$table.'` created successfully for `'.$fuse.'`.');
    }
    ...
    {
        $form_path = 'Fuses/'.$this->getFuse().'/app/View/Forms/';
    ...
    {
        $table_path = 'Fuses/'.$this->getFuse().'/app/View/Tables/';
