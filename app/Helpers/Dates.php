...
class Dates
{
    ...
    public static function datetime(bool|int|null|string $time = false)
    {
        if ($time === null) {
            return ___('acronyms.na');
        }
    ...
    public static function datetime_formats(): array
    {
        return [
    ...
    public static function getTimeUntilDate($date): DateInterval
    {
    ...
    public static function process_date(Carbon $carbon, array $data = []): array
    {
        return array_merge(
            [
    ...
    public static function time_as_hours($hours = 0, $minutes = 0): string
    {
        $hours += $minutes / 60;
    ...
    // Time ago
    public static function time_ago(string $date, $full = false, bool $absolute = false): string
    {
        return now()
            ->parse($date)
            ->diffForHumans(
                ...
                syntax: $absolute ? CarbonInterface::DIFF_ABSOLUTE : null
            );
    }
