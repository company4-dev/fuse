...
class Settings
{
    ...
    public static function load()
    {
        ...
        // foreach (Fuses::active()->get() as $fuse) {
        //     $migration_parameters['--path'][] = $fuse->getPath().'/database/migrations/tenant';
        // }
        ...
        config([
            ...
            //     1,
            //     function () {
            //         $base_fuse = Fuses::active()->first();

            //         return $base_fuse ? config($base_fuse->getLowerName())['name'] : config('app.name');
            //     }
            // ),
            'settings'                     => $formatted,
