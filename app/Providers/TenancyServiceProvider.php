...
class TenancyServiceProvider extends ServiceProvider
{
        ...
        return [
            ...
            TenantCreated::class  => [
                JobPipeline
                    ...
                    ->send(static fn (TenantCreated $event) => $event->tenant)
            ...
            TenantDeleted::class  => [
                JobPipeline
                    ...
                    ->send(static fn (TenantDeleted $event) => $event->tenant)
                    // `false` by default, but you probably want to make this `true` for production.
                    ->shouldBeQueued(false),
            ],
            ...
            /**
             * Fired only when a synced resource is changed in a different DB than the origin DB (to avoid infinite
             * loops).
             */
    ...
    public function boot(): void
    {
        ...
        if (!config('settings.tenancy.enabled')) {
            ...
            Livewire::setUpdateRoute(static fn ($handle) => Route
