...
return [
    ...
    */
    'stubs' => [
        'enabled' => false,
        'path'    => base_path('stubs/platforms'),
        'files'   => [
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            // tests/
            'test-architecture' => ['path' => 'tests/Architecture', 'generate' => true],
    ...
    */
    'activators' => [
        'file' => [
            ...
            'statuses-file' => base_path('storage/app/platform_statuses.json'),
        ],
    ],
