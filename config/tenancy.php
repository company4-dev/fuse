...
return [
    ...
    'filesystem' => [
         ...
         *
         * Note: Disabling this will likely break local disk tenancy. Only disable this if you're using an external file
    ...
    'features' => [
        ...
        // https://tenancyforlaravel.com/docs/v3/features/tenant-config
        // Stancl\Tenancy\Features\TenantConfig::class,
        // https://tenancyforlaravel.com/docs/v3/features/cross-domain-redirect
    ...
    'migration_parameters' => [
        ...
        '--path'     => null, // This is set within the TenancyServiceProvider.
        '--realpath' => true,
    ],
