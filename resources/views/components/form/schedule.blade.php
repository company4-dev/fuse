...
<div x-data="{{ $alpine_data }}">
    ...
    <flux:field class="mb-5">
        ...
        <flux:date-picker :placeholder="___('dictionary.select...')" wire:model.live.change="{{ $fields['start-date']['name'] }}"/>
    ...
    <flux:field class="mb-5">
        <flux:radio.group
            ...
            wire:model.live.change="{{ $fields['end-type']['name'] }}"
    ...
    <flux:field class="mb-5" x-show="alpine_end_type == 1">
        ...
        <flux:date-picker :placeholder="___('dictionary.select...')" wire:model.live.change="{{ $fields['end-date']['name'] }}" />
    ...
    <flux:field class="mb-5">
        <flux:radio.group
            ...
            wire:model.live.change="{{ $fields['schedule']['name'] }}"
    ...
    <div x-show="alpine_recurrence == 1">
        ...
        <flux:field class="mb-5">
            <flux:radio.group
                ...
                wire:model.live.change="{{ $fields['daily-type']['name'] }}"
    ...
    <div x-show="alpine_recurrence == 2">
        ...
        <flux:field class="mb-5">
            ...
            <flux:select
                ...
                searchable
                variant="listbox"
                wire:model.live.change="{{ $fields['weekly-on']['name'] }}"
    ...
    <div x-show="alpine_recurrence == 3">
        ...
        <flux:field class="mb-5">
            <flux:radio.group
                ...
                wire:model.live.change="{{ $fields['monthly-type']['name'] }}"
                x-on:change="alpine_recurrence_type_3 = $event.target.value"
            >
                <div class="flex gap-4 *:gap-x-2">
        ...
        <flux:field class="mb-5" x-show="alpine_recurrence_type_3 == 1">
            ...
            <flux:select
                ...
                searchable
                variant="listbox"
                wire:model.live.change="{{ $fields['monthly-day']['name'] }}"
            >
        ...
        <div x-show="alpine_recurrence_type_3 == 2">
            ...
            <flux:field class="mb-5">
                <flux:radio.group
                    ...
                    wire:model.live.change="{{ $fields['monthly-week']['name'] }}"
                >
                    <div class="flex gap-4 *:gap-x-2">
            ...
            <flux:field class="mb-5">
                ...
                <flux:select
                    ...
                    searchable
                    variant="listbox"
                    wire:model.live.change="{{ $fields['monthly-dow']['name'] }}"
                >
    ...
    <div x-show="alpine_recurrence == 4">
        ...
        <flux:field class="mb-5">
            <flux:radio.group
                ...
                wire:model.live.change="{{ $fields['yearly-type']['name'] }}"
        ...
        <flux:field class="mb-5" x-show="alpine_recurrence_type_4 == 1">
            ...
            <flux:select
                ...
                searchable
                variant="listbox"
                wire:model.live.change="{{ $fields['yearly-day']['name'] }}"
            >
        ...
        <div x-show="alpine_recurrence_type_4 == 2">
            ...
            <flux:field class="mb-5">
                <flux:radio.group
                    ...
                    wire:model.live.change="{{ $fields['yearly-week']['name'] }}"
                >
                    <div class="flex gap-4 *:gap-x-2">
            ...
            <flux:field class="mb-5">
                ...
                <flux:select
                    ...
                    searchable
                    variant="listbox"
                    wire:model.live.change="{{ $fields['yearly-dow']['name'] }}"
                >
        ...
        <flux:field class="mb-5" x-show="alpine_recurrence_type_4 == 1 || recurrence_type_4 == 2">
            ...
            <flux:select
                ...
                searchable
                variant="listbox"
                wire:model.live.change="{{ $fields['yearly-month']['name'] }}"
            >
