<form wire:submit.prevent>
    ...
    @else
        <flux:separator class="mt-3 mb-6" wire:loading.flex.remove />
    @endif

    <div class="flex justify-end items-center gap-3" wire:loading.flex.remove>
