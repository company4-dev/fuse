...
@if ($expandable && $heading)
    ...
    >
        ...
        >
            <div class="ps-3 pe-4">
                <x-icon class="hidden size-3! group-data-open/disclosure-button:block" icon="chevron-down" />
                <x-icon class="block size-3! group-data-open/disclosure-button:hidden" icon="chevron-right" />
            </div>
